...
def Generator():
    os.system("cls")
    ctypes.windll.kernel32.SetConsoleTitleW(f"[Nitro Tool] By Kele | Nitro Generator")
    generated = 0
...
{Fore.LIGHTBLACK_EX}Made By Kele | Nitro Code Generator
    ''')
    ...
    for kele in range(int(num)):
        ...
        ctypes.windll.kernel32.SetConsoleTitleW(f"[Nitro Tool] By Kele | Generated: %s" % generated)
        generated += 1
...
{Fore.LIGHTBLACK_EX}Made By Kele | Nitro Code Checker
    ''')
    ...
    for line in f:
        ...
        if r.status_code == 200:
            ...
            break
            ctypes.windll.kernel32.SetConsoleTitleW(f"[Nitro Tool] By Kele | Checked: %s" % checked)
            checked += 1
        else:
